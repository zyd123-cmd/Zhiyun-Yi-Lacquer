...
var _article = _interopRequireDefault(__webpack_require__(/*! ./subcontentpkg/hottopic/article0/article0.vue */ 95));
// @ts-ignore
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _article0_vue_vue_type_template_id_e5254068___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./article0.vue?vue&type=template&id=e5254068& */ 96);
/* harmony import */ var _article0_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./article0.vue?vue&type=script&lang=js& */ 98);
...
/* harmony import */ var _article0_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./article0.vue?vue&type=style&index=0&lang=css& */ 100);
...
var _default = {
  ...
  computed: _objectSpread(_objectSpread(_objectSpread({}, (0, _vuex.mapState)('m_article', ['favoriteArticles', 'likedArticles'])), (0, _vuex.mapState)('m_user', ['isLoggedIn'])), {}, {
  ...
  methods: _objectSpread(_objectSpread({}, (0, _vuex.mapMutations)('m_article', ['toggleFavoriteArticle', 'toggleLikedArticle'])), {}, {
    getArticleCollectionNames: function getArticleCollectionNames() {
      return [_cloud.COLLECTIONS.ARTICLES].concat((0, _toConsumableArray2.default)(_cloud.COLLECTION_FALLBACKS.ARTICLES));
    },
    ...
    syncFavoriteState: function syncFavoriteState() {
      ...
      this.isFavorite = this.favoriteArticles.some(function (item) {
        return item.id === _this.article._id;
      });
    },
    ...
    openImageActions: function openImageActions(currentImage) {
      ...
      wx.showActionSheet({
        ...
        success: function success(_ref) {
          ...
          if (tapIndex === 0) {
            _this3.previewImage(currentImage);
          }
        }
      });
    },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return (0, _cloud.runCollectionWithFallback)(_this4.getArticleCollectionNames(), function (collectionName) {
                  return db.collection(collectionName).doc(_this4.articleId).get();
                }, {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                console.warn('文章详情云函数不可用，已回退数据库直连:', _context2.t0);
                _context2.next = 15;
                return _this5.loadArticleFromDatabase();
              case 15:
                articleData = _context2.sent;
              case 16:
                _this5.applyArticleData(articleData || {});
                _context2.next = 23;
                break;
              case 19:
                _context2.prev = 19;
                _context2.t1 = _context2["catch"](1);
                console.error('文章详情加载失败:', _context2.t1);
                uni.showToast({
                  title: '内容加载失败',
                  icon: 'none'
                });
        ...
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                _this7.toggleFavoriteArticle(_this7.getFavoritePayload());
                _this7.syncFavoriteState();
              case 6:
              case "end":
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 7:
                ...
                console.warn('点赞云函数不可用，尝试直连数据库更新:', _context5.t0);
              case 10:
                db = wx.cloud.database();
                command = db.command;
                _context5.next = 14;
                return (0, _cloud.runCollectionWithFallback)(_this8.getArticleCollectionNames(), function (collectionName) {
                  return db.collection(collectionName).doc(_this8.article._id).update({
                    data: {
        ...
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                delta = _this9.isLiked ? -1 : 1;
                _this9.toggleLikedArticle({
                  id: _this9.article._id
                });
                _this9.syncLikeState();
                _this9.likeCount = Math.max(0, _this9.likeCount + delta);
                _context6.prev = 8;
                _context6.next = 11;
                return _this9.persistLikeChange(delta);
              case 11:
                _context6.next = 20;
                break;
              case 13:
                ...
                console.error('更新点赞状态失败:', _context6.t0);
                _this9.toggleLikedArticle({
                  id: _this9.article._id
                });
                _this9.syncLikeState();
